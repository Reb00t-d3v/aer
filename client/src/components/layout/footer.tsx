    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <div className="flex items-center mb-4">
              <span className="text-primary font-bold text-2xl">Removo</span>
            </div>
            <p className="text-gray-400 mb-4">
              Modern AI-powered background removal tool that delivers professional results in seconds.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-gray-400 text-sm text-center">
          <p>&copy; {new Date().getFullYear()} Removo. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
